...
public partial class FmodEvent : Node {
    ...
    public void Release() {
        ...
        if (IsPlaying) {
            FmodInstance.Call("stop", FmodServer.FMOD_STUDIO_STOP_IMMEDIATE);
        }
    ...
    public void Stop(bool immediate = false) {
        if (IsPlaying) {
            int stopMode = immediate ? FmodServer.FMOD_STUDIO_STOP_IMMEDIATE : FmodServer.FMOD_STUDIO_STOP_ALLOWFADEOUT;
            FmodInstance.Call("stop", stopMode);
        }
    }
