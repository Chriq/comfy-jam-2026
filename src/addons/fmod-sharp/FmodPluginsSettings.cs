...
public class FmodPluginsSettings
{
    // Engine object used for calling engine methods
    protected Resource _object;

    public FmodPluginsSettings() : this(NativeName)
    {
    }
    protected FmodPluginsSettings(StringName @class) : this(ClassDB.Instantiate(@class))
    {
    }
    protected FmodPluginsSettings(Variant variant) : this((Resource)variant)
    {
    }
    protected FmodPluginsSettings([NotNull] Resource @object)
    {
        _object = @object;
    }

    public static implicit operator Resource(FmodPluginsSettings self) => self?._object;
    public static implicit operator Variant(FmodPluginsSettings self) => self?._object;
    public static explicit operator FmodPluginsSettings(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

    public class PropertyName : Resource.PropertyName
    {
        public static readonly StringName PluginsBasePath = "plugins_base_path";
        public static readonly StringName DynamicPluginList = "dynamic_plugin_list";
        public static readonly StringName StaticPluginsMethods = "static_plugins_methods";
    }

    public class MethodName : Resource.MethodName
    {
        public static readonly StringName SetPluginsBasePath = "set_plugins_base_path";
        public static readonly StringName GetFmodPluginsBasePath = "get_fmod_plugins_base_path";
        public static readonly StringName SetDynamicPluginList = "set_dynamic_plugin_list";
        public static readonly StringName GetDynamicPluginList = "get_dynamic_plugin_list";
        public static readonly StringName SetStaticPluginsMethods = "set_static_plugins_methods";
        public static readonly StringName GetStaticPluginsMethods = "get_static_plugins_methods";
    }
    ...
    private static readonly StringName NativeName = "FmodPluginsSettings";

    #region Properties

    public string PluginsBasePath
    {
        get => (string)_object.Get(PropertyName.PluginsBasePath);
        set => _object.Set(PropertyName.PluginsBasePath, value);
    }

    public string[] DynamicPluginList
    {
        get => (string[])_object.Get(PropertyName.DynamicPluginList);
        set => _object.Set(PropertyName.DynamicPluginList, value);
    }

    public Godot.Collections.Array StaticPluginsMethods
    {
        get => (Godot.Collections.Array)_object.Get(PropertyName.StaticPluginsMethods);
        set => _object.Set(PropertyName.StaticPluginsMethods, value);
    }
    ...
    public void SetPluginsBasePath(string @p_base_path)
    {
        _object.Call(MethodName.SetPluginsBasePath, @p_base_path);
    }

    public string GetFmodPluginsBasePath()
    {
        return (string)_object.Call(MethodName.GetFmodPluginsBasePath);
    }

    public void SetDynamicPluginList(string[] @p_dynamic_plugin_list)
    {
        _object.Call(MethodName.SetDynamicPluginList, @p_dynamic_plugin_list);
    }

    public string[] GetDynamicPluginList()
    {
        return (string[])_object.Call(MethodName.GetDynamicPluginList);
    }

    public void SetStaticPluginsMethods(Godot.Collections.Array @p_static_plugins_settings)
    {
        _object.Call(MethodName.SetStaticPluginsMethods, @p_static_plugins_settings);
    }

    public Godot.Collections.Array GetStaticPluginsMethods()
    {
        return (Godot.Collections.Array)_object.Call(MethodName.GetStaticPluginsMethods);
    }
