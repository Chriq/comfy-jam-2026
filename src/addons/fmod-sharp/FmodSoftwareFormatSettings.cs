...
public class FmodSoftwareFormatSettings
{
    // Engine object used for calling engine methods
    protected Resource _object;

    public FmodSoftwareFormatSettings() : this(NativeName)
    {
    }
    protected FmodSoftwareFormatSettings(StringName @class) : this(ClassDB.Instantiate(@class))
    {
    }
    protected FmodSoftwareFormatSettings(Variant variant) : this((Resource)variant)
    {
    }
    protected FmodSoftwareFormatSettings([NotNull] Resource @object)
    {
        _object = @object;
    }

    public static implicit operator Resource(FmodSoftwareFormatSettings self) => self?._object;
    public static implicit operator Variant(FmodSoftwareFormatSettings self) => self?._object;
    public static explicit operator FmodSoftwareFormatSettings(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

    public class PropertyName : Resource.PropertyName
    {
        public static readonly StringName SampleRate = "sample_rate";
        public static readonly StringName SpeakerMode = "speaker_mode";
        public static readonly StringName RawSpeakersCount = "raw_speakers_count";
    }

    public class MethodName : Resource.MethodName
    {
        public static readonly StringName SetSampleRate = "set_sample_rate";
        public static readonly StringName GetSampleRate = "get_sample_rate";
        public static readonly StringName SetSpeakerMode = "set_speaker_mode";
        public static readonly StringName GetSpeakerMode = "get_speaker_mode";
        public static readonly StringName SetRawSpeakersCount = "set_raw_speakers_count";
        public static readonly StringName GetRawSpeakersCount = "get_raw_speakers_count";
    }
    ...
    private static readonly StringName NativeName = "FmodSoftwareFormatSettings";

    #region Properties

    public int SampleRate
    {
        get => (int)_object.Get(PropertyName.SampleRate);
        set => _object.Set(PropertyName.SampleRate, value);
    }

    public int SpeakerMode
    {
        get => (int)_object.Get(PropertyName.SpeakerMode);
        set => _object.Set(PropertyName.SpeakerMode, value);
    }

    public int RawSpeakersCount
    {
        get => (int)_object.Get(PropertyName.RawSpeakersCount);
        set => _object.Set(PropertyName.RawSpeakersCount, value);
    }
    ...
    public void SetSampleRate(int @p_sample_rate)
    {
        _object.Call(MethodName.SetSampleRate, @p_sample_rate);
    }

    public int GetSampleRate()
    {
        return (int)_object.Call(MethodName.GetSampleRate);
    }

    public void SetSpeakerMode(int @p_speaker_mode)
    {
        _object.Call(MethodName.SetSpeakerMode, @p_speaker_mode);
    }

    public int GetSpeakerMode()
    {
        return (int)_object.Call(MethodName.GetSpeakerMode);
    }

    public void SetRawSpeakersCount(int @p_raw_speakers_count)
    {
        _object.Call(MethodName.SetRawSpeakersCount, @p_raw_speakers_count);
    }

    public int GetRawSpeakersCount()
    {
        return (int)_object.Call(MethodName.GetRawSpeakersCount);
    }
