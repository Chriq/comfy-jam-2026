...
public class FmodEditorExportPlugin
{
    // Engine object used for calling engine methods
    protected EditorExportPlugin _object;

    public FmodEditorExportPlugin() : this(NativeName)
    {
    }
    protected FmodEditorExportPlugin(StringName @class) : this(ClassDB.Instantiate(@class))
    {
    }
    protected FmodEditorExportPlugin(Variant variant) : this((EditorExportPlugin)variant)
    {
    }
    protected FmodEditorExportPlugin([NotNull] EditorExportPlugin @object)
    {
        _object = @object;
    }

    public static implicit operator EditorExportPlugin(FmodEditorExportPlugin self) => self?._object;
    public static implicit operator Variant(FmodEditorExportPlugin self) => self?._object;
    public static explicit operator FmodEditorExportPlugin(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

    public class PropertyName : EditorExportPlugin.PropertyName
    {

    }

    public class MethodName : EditorExportPlugin.MethodName
    {

    }

    public class SignalName : EditorExportPlugin.SignalName
    {

    }

    private static readonly StringName NativeName = "FmodEditorExportPlugin";

    #region Inherited Methods

    public void AddSharedObject(string @path, string[] @tags, string @target)
    {
        _object.AddSharedObject(@path, @tags, @target);
    }

    public void AddFile(string @path, byte[] @file, bool @remap)
    {
        _object.AddFile(@path, @file, @remap);
    }

    public void AddAppleEmbeddedPlatformProjectStaticLib(string @path)
    {
        _object.AddAppleEmbeddedPlatformProjectStaticLib(@path);
    }

    public void AddAppleEmbeddedPlatformFramework(string @path)
    {
        _object.AddAppleEmbeddedPlatformFramework(@path);
    }

    public void AddAppleEmbeddedPlatformEmbeddedFramework(string @path)
    {
        _object.AddAppleEmbeddedPlatformEmbeddedFramework(@path);
    }

    public void AddAppleEmbeddedPlatformPlistContent(string @plist_content)
    {
        _object.AddAppleEmbeddedPlatformPlistContent(@plist_content);
    }

    public void AddAppleEmbeddedPlatformLinkerFlags(string @flags)
    {
        _object.AddAppleEmbeddedPlatformLinkerFlags(@flags);
    }

    public void AddAppleEmbeddedPlatformBundleFile(string @path)
    {
        _object.AddAppleEmbeddedPlatformBundleFile(@path);
    }

    public void AddAppleEmbeddedPlatformCppCode(string @code)
    {
        _object.AddAppleEmbeddedPlatformCppCode(@code);
    }

    public void AddIosProjectStaticLib(string @path)
    {
        _object.AddIosProjectStaticLib(@path);
    }

    public void AddIosFramework(string @path)
    {
        _object.AddIosFramework(@path);
    }

    public void AddIosEmbeddedFramework(string @path)
    {
        _object.AddIosEmbeddedFramework(@path);
    }

    public void AddIosPlistContent(string @plist_content)
    {
        _object.AddIosPlistContent(@plist_content);
    }

    public void AddIosLinkerFlags(string @flags)
    {
        _object.AddIosLinkerFlags(@flags);
    }

    public void AddIosBundleFile(string @path)
    {
        _object.AddIosBundleFile(@path);
    }

    public void AddIosCppCode(string @code)
    {
        _object.AddIosCppCode(@code);
    }

    public void AddMacosPluginFile(string @path)
    {
        _object.AddMacOSPluginFile(@path);
    }
    ...
    public Variant GetOption(Godot.StringName @name)
    {
        return _object.GetOption(@name);
    }

    public EditorExportPreset GetExportPreset()
    {
        return _object.GetExportPreset();
    }

    public EditorExportPlatform GetExportPlatform()
    {
        return _object.GetExportPlatform();
    }
