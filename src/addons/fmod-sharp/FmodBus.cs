...
public class FmodBus
{
	...
	public FmodBus() : this(NativeName)
	{
	}
	protected FmodBus(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodBus(Variant variant) : this((RefCounted) variant)
	{
	}
	protected FmodBus([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(FmodBus self) => self?._object;
	public static implicit operator Variant(FmodBus self) => self?._object;
	public static explicit operator FmodBus(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	public class MethodName : RefCounted.MethodName
	{
		...
		public static readonly StringName StopAllEvents = "stop_all_events";
	...
	private static readonly StringName NativeName = "FmodBus";
	...
	{
		_object.Call(MethodName.StopAllEvents, @stopMode);
	}
