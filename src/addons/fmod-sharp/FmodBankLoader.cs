...
public class FmodBankLoader
{
    // Engine object used for calling engine methods
    protected Node _object;

    public FmodBankLoader() : this(NativeName)
    {
    }
    protected FmodBankLoader(StringName @class) : this(ClassDB.Instantiate(@class))
    {
    }
    protected FmodBankLoader(Variant variant) : this((Node)variant)
    {
    }
    protected FmodBankLoader([NotNull] Node @object)
    {
        _object = @object;
    }

    public static implicit operator Node(FmodBankLoader self) => self?._object;
    public static implicit operator Variant(FmodBankLoader self) => self?._object;
    public static explicit operator FmodBankLoader(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

    public class PropertyName : Node.PropertyName
    {
        public static readonly StringName BankPaths = "bank_paths";
    }

    public class MethodName : Node.MethodName
    {
        public static readonly StringName SetBankPaths = "set_bank_paths";
        public static readonly StringName GetBankPaths = "get_bank_paths";
    }
    ...
    private static readonly StringName NativeName = "FmodBankLoader";

    #region Properties

    public Godot.Collections.Array BankPaths
    {
        get => (Godot.Collections.Array)_object.Get(PropertyName.BankPaths);
        set => _object.Set(PropertyName.BankPaths, value);
    }
    ...
    public void SetBankPaths(Godot.Collections.Array @p_paths)
    {
        _object.Call(MethodName.SetBankPaths, @p_paths);
    }

    public Godot.Collections.Array GetBankPaths()
    {
        return (Godot.Collections.Array)_object.Call(MethodName.GetBankPaths);
    }
