...
public class FmodDspSettings
{
    // Engine object used for calling engine methods
    protected Resource _object;

    public FmodDspSettings() : this(NativeName)
    {
    }
    protected FmodDspSettings(StringName @class) : this(ClassDB.Instantiate(@class))
    {
    }
    protected FmodDspSettings(Variant variant) : this((Resource)variant)
    {
    }
    protected FmodDspSettings([NotNull] Resource @object)
    {
        _object = @object;
    }

    public static implicit operator Resource(FmodDspSettings self) => self?._object;
    public static implicit operator Variant(FmodDspSettings self) => self?._object;
    public static explicit operator FmodDspSettings(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

    public class PropertyName : Resource.PropertyName
    {
        public static readonly StringName DspBufferSize = "dsp_buffer_size";
        public static readonly StringName DspBufferCount = "dsp_buffer_count";
    }

    public class MethodName : Resource.MethodName
    {
        public static readonly StringName SetDspBufferSize = "set_dsp_buffer_size";
        public static readonly StringName GetDspBufferSize = "get_dsp_buffer_size";
        public static readonly StringName SetDspBufferCount = "set_dsp_buffer_count";
        public static readonly StringName GetDspBufferCount = "get_dsp_buffer_count";
    }
    ...
    private static readonly StringName NativeName = "FmodDspSettings";

    #region Properties

    public int DspBufferSize
    {
        get => (int)_object.Get(PropertyName.DspBufferSize);
        set => _object.Set(PropertyName.DspBufferSize, value);
    }

    public int DspBufferCount
    {
        get => (int)_object.Get(PropertyName.DspBufferCount);
        set => _object.Set(PropertyName.DspBufferCount, value);
    }
    ...
    public void SetDspBufferSize(int @p_dsp_buffer_size)
    {
        _object.Call(MethodName.SetDspBufferSize, @p_dsp_buffer_size);
    }

    public int GetDspBufferSize()
    {
        return (int)_object.Call(MethodName.GetDspBufferSize);
    }

    public void SetDspBufferCount(int @p_dsp_buffer_count)
    {
        _object.Call(MethodName.SetDspBufferCount, @p_dsp_buffer_count);
    }

    public int GetDspBufferCount()
    {
        return (int)_object.Call(MethodName.GetDspBufferCount);
    }
