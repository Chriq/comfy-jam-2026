...
public class FmodPerformanceData
{
	...
	public FmodPerformanceData() : this(NativeName)
	{
	}
	protected FmodPerformanceData(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodPerformanceData(Variant variant) : this((RefCounted) variant)
	{
	}
	protected FmodPerformanceData([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(FmodPerformanceData self) => self?._object;
	public static implicit operator Variant(FmodPerformanceData self) => self?._object;
	public static explicit operator FmodPerformanceData(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : RefCounted.PropertyName
	{
		public static readonly StringName Dsp = "dsp";
		...
		public static readonly StringName Convolution1 = "convolution1";
		public static readonly StringName Convolution2 = "convolution2";
		public static readonly StringName Studio = "studio";
		public static readonly StringName CurrentlyAllocated = "currently_allocated";
		public static readonly StringName MaxAllocated = "max_allocated";
		public static readonly StringName SampleBytesRead = "sample_bytes_read";
		public static readonly StringName StreamBytesRead = "stream_bytes_read";
		public static readonly StringName OtherBytesRead = "other_bytes_read";
	}

	public class MethodName : RefCounted.MethodName
	{
		public static readonly StringName GetDsp = "get_dsp";
		public static readonly StringName GetGeometry = "get_geometry";
		public static readonly StringName GetStream = "get_stream";
		public static readonly StringName GetUpdate = "get_update";
		public static readonly StringName GetConvolution1 = "get_convolution1";
		public static readonly StringName GetConvolution2 = "get_convolution2";
		public static readonly StringName GetStudio = "get_studio";
		public static readonly StringName GetCurrentlyAllocated = "get_currently_allocated";
		public static readonly StringName GetMaxAllocated = "get_max_allocated";
		public static readonly StringName GetSampleBytesRead = "get_sample_bytes_read";
		public static readonly StringName GetStreamBytesRead = "get_stream_bytes_read";
		public static readonly StringName GetOtherBytesRead = "get_other_bytes_read";
	}
	...
	private static readonly StringName NativeName = "FmodPerformanceData";

	#region Properties

	public float Dsp
	{
		get => (float)_object.Get(PropertyName.Dsp);
	}

	public float Geometry
	{
		get => (float)_object.Get(PropertyName.Geometry);
	}

	public float Stream
	{
		get => (float)_object.Get(PropertyName.Stream);
	}

	public float Update
	{
		get => (float)_object.Get(PropertyName.Update);
	}

	public float Convolution1
	{
		get => (float)_object.Get(PropertyName.Convolution1);
	}

	public float Convolution2
	{
		get => (float)_object.Get(PropertyName.Convolution2);
	}

	public float Studio
	{
		get => (float)_object.Get(PropertyName.Studio);
	}

	public int CurrentlyAllocated
	{
		get => (int)_object.Get(PropertyName.CurrentlyAllocated);
	}

	public int MaxAllocated
	{
		get => (int)_object.Get(PropertyName.MaxAllocated);
	}

	public int SampleBytesRead
	{
		get => (int)_object.Get(PropertyName.SampleBytesRead);
	}

	public int StreamBytesRead
	{
		get => (int)_object.Get(PropertyName.StreamBytesRead);
	}

	public int OtherBytesRead
	{
		get => (int)_object.Get(PropertyName.OtherBytesRead);
	}
	...
	public float GetDsp()
	{
		return (float)_object.Call(MethodName.GetDsp);
	}

	public float GetGeometry()
	{
		return (float)_object.Call(MethodName.GetGeometry);
	}

	public float GetStream()
	{
		return (float)_object.Call(MethodName.GetStream);
	}

	public float GetUpdate()
	{
		return (float)_object.Call(MethodName.GetUpdate);
	}

	public float GetConvolution1()
	{
		return (float)_object.Call(MethodName.GetConvolution1);
	}

	public float GetConvolution2()
	{
		return (float)_object.Call(MethodName.GetConvolution2);
	}

	public float GetStudio()
	{
		return (float)_object.Call(MethodName.GetStudio);
	}

	public int GetCurrentlyAllocated()
	{
		return (int)_object.Call(MethodName.GetCurrentlyAllocated);
	}

	public int GetMaxAllocated()
	{
		return (int)_object.Call(MethodName.GetMaxAllocated);
	}

	public int GetSampleBytesRead()
	{
		return (int)_object.Call(MethodName.GetSampleBytesRead);
	}

	public int GetStreamBytesRead()
	{
		return (int)_object.Call(MethodName.GetStreamBytesRead);
	}

	public int GetOtherBytesRead()
	{
		return (int)_object.Call(MethodName.GetOtherBytesRead);
	}
