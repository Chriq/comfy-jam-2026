...
public class FmodListener3D
{
    // Engine object used for calling engine methods
    protected Node3D _object;

    public FmodListener3D() : this(NativeName)
    {
    }
    protected FmodListener3D(StringName @class) : this(ClassDB.Instantiate(@class))
    {
    }
    protected FmodListener3D(Variant variant) : this((Node3D)variant)
    {
    }
    protected FmodListener3D([NotNull] Node3D @object)
    {
        _object = @object;
    }

    public static implicit operator Node3D(FmodListener3D self) => self?._object;
    public static implicit operator Variant(FmodListener3D self) => self?._object;
    public static explicit operator FmodListener3D(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
    ...
    private static readonly StringName NativeName = "FmodListener3D";
