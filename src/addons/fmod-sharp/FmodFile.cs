...
public class FmodFile
{
	...
	public FmodFile() : this(NativeName)
	{
	}
	protected FmodFile(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodFile(Variant variant) : this((RefCounted) variant)
	{
	}
	protected FmodFile([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(FmodFile self) => self?._object;
	public static implicit operator Variant(FmodFile self) => self?._object;
	public static explicit operator FmodFile(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "FmodFile";
