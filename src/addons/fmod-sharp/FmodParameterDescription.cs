...
public class FmodParameterDescription
{
	// Engine object used for calling engine methods
	protected RefCounted _object;

	public FmodParameterDescription() : this(NativeName)
	{
	}
	protected FmodParameterDescription(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodParameterDescription(Variant variant) : this((RefCounted) variant)
	{
	}
	protected FmodParameterDescription([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(FmodParameterDescription self) => self?._object;
	public static implicit operator Variant(FmodParameterDescription self) => self?._object;
	public static explicit operator FmodParameterDescription(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	public class MethodName : RefCounted.MethodName
	{
		...
		public static readonly StringName GetMinimum = "get_minimum";
		public static readonly StringName GetMaximum = "get_maximum";
		...
		public static readonly StringName IsAutomatic = "is_automatic";
		public static readonly StringName IsGlobal = "is_global";
		public static readonly StringName IsDiscrete = "is_discrete";
		public static readonly StringName IsLabeled = "is_labeled";
	}
	...
	private static readonly StringName NativeName = "FmodParameterDescription";
	...
	public int GetId()
	{
		return (int)_object.Call(MethodName.GetId);
	}

	public float GetMinimum()
	{
		return (float)_object.Call(MethodName.GetMinimum);
	}

	public float GetMaximum()
	{
		return (float)_object.Call(MethodName.GetMaximum);
	}

	public float GetDefaultValue()
	{
		return (float)_object.Call(MethodName.GetDefaultValue);
	}

	public bool IsReadOnly()
	{
		return (bool)_object.Call(MethodName.IsReadOnly);
	}

	public bool IsAutomatic()
	{
		return (bool)_object.Call(MethodName.IsAutomatic);
	}

	public bool IsGlobal()
	{
		return (bool)_object.Call(MethodName.IsGlobal);
	}

	public bool IsDiscrete()
	{
		return (bool)_object.Call(MethodName.IsDiscrete);
	}

	public bool IsLabeled()
	{
		return (bool)_object.Call(MethodName.IsLabeled);
	}
