...
public partial class FmodServer : Node {
    ...
    public static void AddListener(int index, Node gameObj) => Server.Call("add_listener", index, gameObj);

    public static bool BanksStillLoading() {
        var result = Server.Call("banks_still_loading");
        return result.AsBool();
    }

    public static bool CheckBusGuid(string guid) {
        var result = Server.Call("check_bus_guid", guid);
        return result.AsBool();
    }

    public static bool CheckBusPath(string busPath) {
        var result = Server.Call("check_bus_path", busPath);
        return result.AsBool();
    }

    public static bool CheckEventGuid(string guid) {
        var result = Server.Call("check_event_guid", guid);
        return result.AsBool();
    }

    public static bool CheckEventPath(string eventPath) {
        var result = Server.Call("check_event_path", eventPath);
        return result.AsBool();
    }

    public static bool CheckVcaGuid(string guid) {
        var result = Server.Call("check_vca_guid", guid);
        return result.AsBool();
    }

    public static bool CheckVcaPath(string vcaPath) {
        var result = Server.Call("check_vca_path", vcaPath);
        return result.AsBool();
    }
    ...
    public static FmodEvent? CreateEventInstance(string eventPath) {
        ...
        var result = Server.Call("create_event_instance", eventPath);
    ...
    public static FmodEvent? CreateEventInstanceFromDescription(GodotObject eventDescription) {
        var result = Server.Call("create_event_instance_from_description", eventDescription);
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static FmodEvent? CreateEventInstanceWithGuid(string guid) {
        var result = Server.Call("create_event_instance_with_guid", guid);
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static GodotObject? CreateSoundInstance(string path) {
        var result = Server.Call("create_sound_instance", path);
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static Godot.Collections.Array GetAllBanks() => (Godot.Collections.Array)Server.Call("get_all_banks");

    public static Godot.Collections.Array GetAllBuses() => (Godot.Collections.Array)Server.Call("get_all_buses");

    public static Godot.Collections.Array GetAllEventDescriptions() => (Godot.Collections.Array)Server.Call("get_all_event_descriptions");

    public static Godot.Collections.Array GetAllVca() => (Godot.Collections.Array)Server.Call("get_all_vca");

    public static Godot.Collections.Array GetAvailableDrivers() => (Godot.Collections.Array)Server.Call("get_available_drivers");

    public static FmodBus? GetBus(string busPath) {
        var result = Server.Call("get_bus", busPath);
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static FmodBus? GetBusFromGuid(string guid) {
        var result = Server.Call("get_bus_from_guid", guid);
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static int GetDriver() {
        var result = Server.Call("get_driver");
        return result.AsInt32();
    }

    public static GodotObject? GetEvent(string eventPath) {
        if (!ValidateEventPath(eventPath)) return null;
        var result = Server.Call("get_event", eventPath);
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static GodotObject? GetEventFromGuid(string guid) {
        var result = Server.Call("get_event_from_guid", guid);
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static string GetEventGuid(string eventPath) {
        ...
        var result = Server.Call("get_event_guid", eventPath);
        return result.AsString();
    }

    public static string GetEventPath(string guid) {
        var result = Server.Call("get_event_path", guid);
        return result.AsString();
    }

    public static float GetGlobalParameterById(long parameterId) {
        var result = Server.Call("get_global_parameter_by_id", parameterId);
        return result.AsSingle();
    }

    public static float GetGlobalParameterByName(string parameterName) {
        var result = Server.Call("get_global_parameter_by_name", parameterName);
        return result.AsSingle();
    }

    public static Godot.Collections.Dictionary GetGlobalParameterDescById(long parameterId) => (Godot.Collections.Dictionary)Server.Call("get_global_parameter_desc_by_id", parameterId);

    public static Godot.Collections.Dictionary GetGlobalParameterDescByName(string parameterName) => (Godot.Collections.Dictionary)Server.Call("get_global_parameter_desc_by_name", parameterName);

    public static int GetGlobalParameterDescCount() {
        var result = Server.Call("get_global_parameter_desc_count");
        return result.AsInt32();
    }

    public static Godot.Collections.Array GetGlobalParameterDescList() => (Godot.Collections.Array)Server.Call("get_global_parameter_desc_list");

    public static Vector2 GetListener2DVelocity(int index) => (Vector2)Server.Call("get_listener_2d_velocity", index);

    public static Vector3 GetListener3DVelocity(int index) => (Vector3)Server.Call("get_listener_3d_velocity", index);

    public static bool GetListenerLock(int index) {
        var result = Server.Call("get_listener_lock", index);
        return result.AsBool();
    }

    public static int GetListenerNumber() {
        var result = Server.Call("get_listener_number");
        return result.AsInt32();
    }

    public static Transform2D GetListenerTransform2D(int index) => (Transform2D)Server.Call("get_listener_transform2d", index);

    public static Transform3D GetListenerTransform3D(int index) => (Transform3D)Server.Call("get_listener_transform3d", index);

    public static float GetListenerWeight(int index) {
        var result = Server.Call("get_listener_weight", index);
        return result.AsSingle();
    }

    public static GodotObject? GetObjectAttachedToListener(int index) {
        var result = Server.Call("get_object_attached_to_listener", index);
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static FmodPerformanceData? GetPerformanceData() {
        var result = Server.Call("get_performance_data");
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static int GetSystemDspBufferLength() {
        var result = Server.Call("get_system_dsp_buffer_length");
        return result.AsInt32();
    }

    public static GodotObject? GetSystemDspBufferSettings() {
        var result = Server.Call("get_system_dsp_buffer_settings");
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static int GetSystemDspNumBuffers() {
        var result = Server.Call("get_system_dsp_num_buffers");
        return result.AsInt32();
    }

    public static FmodVca? GetVca(string vcaPath) {
        var result = Server.Call("get_vca", vcaPath);
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static FmodVca? GetVcaFromGuid(string guid) {
        var result = Server.Call("get_vca_from_guid", guid);
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static void Init(GodotObject generalSettings) => Server.Call("init", generalSettings);

    public static bool IsPluginLoaded(uint pluginHandle) {
        var result = Server.Call("is_plugin_loaded", pluginHandle);
        return result.AsBool();
    }

    public static FmodBank? LoadBank(string path, int flag = 0) {
        var result = Server.Call("load_bank", path, flag);
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static GodotObject? LoadFileAsMusic(string path) {
        var result = Server.Call("load_file_as_music", path);
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static GodotObject? LoadFileAsSound(string path) {
        var result = Server.Call("load_file_as_sound", path);
        var obj = result.AsGodotObject();
        if (obj == null) {
    ...
    public static uint LoadPlugin(string pluginPath, uint priority = 0) {
        var result = Server.Call("load_plugin", pluginPath, priority);
        return result.AsUInt32();
    }

    public static void MuteAllEvents() => Server.Call("mute_all_events");

    public static void PauseAllEvents() => Server.Call("pause_all_events");
    ...
    public static void PlayOneShotAttached(string eventPath, Node gameObject) {
        if (!ValidateEventPath(eventPath)) return;
        Server.Call("play_one_shot_attached", eventPath, gameObject);
    }
    ...
    public static void PlayOneShotAttachedWithParams(string eventPath, Node gameObject, Godot.Collections.Dictionary<string, float> parameters) {
        ...
        Server.Call("play_one_shot_attached_with_params", eventPath, gameObject, godotDict);
    }

    public static void PlayOneShotUsingEventDescription(GodotObject eventDescription) => Server.Call("play_one_shot_using_event_description", eventDescription);

    public static void PlayOneShotUsingEventDescriptionAttached(GodotObject eventDescription, Node gameObj) => Server.Call("play_one_shot_using_event_description_attached", eventDescription, gameObj);

    public static void PlayOneShotUsingEventDescriptionAttachedWithParams(GodotObject eventDescription, Node gameObj, Godot.Collections.Dictionary parameters) => Server.Call("play_one_shot_using_event_description_attached_with_params", eventDescription, gameObj, parameters);

    public static void PlayOneShotUsingEventDescriptionWithParams(GodotObject eventDescription, Godot.Collections.Dictionary parameters) => Server.Call("play_one_shot_using_event_description_with_params", eventDescription, parameters);

    public static void PlayOneShotUsingGuid(string guid) => Server.Call("play_one_shot_using_guid", guid);

    public static void PlayOneShotUsingGuidAttached(string guid, Node gameObj) => Server.Call("play_one_shot_using_guid_attached", guid, gameObj);

    public static void PlayOneShotUsingGuidAttachedWithParams(string guid, Node gameObj, Godot.Collections.Dictionary parameters) => Server.Call("play_one_shot_using_guid_attached_with_params", guid, gameObj, parameters);

    public static void PlayOneShotUsingGuidWithParams(string guid, Godot.Collections.Dictionary parameters) => Server.Call("play_one_shot_using_guid_with_params", guid, parameters);
    ...
    public static void PlayOneShotWithParams(string eventPath, Godot.Collections.Dictionary<string, float> parameters) {
        ...
        Server.Call("play_one_shot_with_params", eventPath, godotDict);
    }

    public static void RemoveListener(int index, Node gameObj) => Server.Call("remove_listener", index, gameObj);

    public static void SetDriver(int id) => Server.Call("set_driver", id);

    public static void SetGlobalParameterById(long parameterId, float value) => Server.Call("set_global_parameter_by_id", parameterId, value);

    public static void SetGlobalParameterByIdWithLabel(long parameterId, string label) => Server.Call("set_global_parameter_by_id_with_label", parameterId, label);

    public static void SetGlobalParameterByName(string parameterName, float value) => Server.Call("set_global_parameter_by_name", parameterName, value);

    public static void SetGlobalParameterByNameWithLabel(string parameterName, string label) => Server.Call("set_global_parameter_by_name_with_label", parameterName, label);

    public static void SetListenerLock(int index, bool isLocked) => Server.Call("set_listener_lock", index, isLocked);

    public static void SetListenerNumber(int listenerNumber) => Server.Call("set_listener_number", listenerNumber);

    public static void SetListenerTransform2D(int index, Transform2D transform) => Server.Call("set_listener_transform2d", index, transform);

    public static void SetListenerTransform3D(int index, Transform3D transform) => Server.Call("set_listener_transform3d", index, transform);

    public static void SetListenerWeight(int index, float weight) => Server.Call("set_listener_weight", index, weight);

    public static void SetSoftwareFormat(GodotObject softwareFormatSettings) => Server.Call("set_software_format", softwareFormatSettings);

    public static void SetSound3DSettings(GodotObject sound3DSettings) => Server.Call("set_sound_3D_settings", sound3DSettings);

    public static void SetSystemDspBufferSize(GodotObject dspSettings) => Server.Call("set_system_dsp_buffer_size", dspSettings);

    public static void Shutdown() => Server.Call("shutdown");

    public static void UnloadFile(string path) => Server.Call("unload_file", path);

    public static void UnloadPlugin(uint pluginHandle) => Server.Call("unload_plugin", pluginHandle);

    public static void UnmuteAllEvents() => Server.Call("unmute_all_events");

    public static void UnpauseAllEvents() => Server.Call("unpause_all_events");

    public static void Update() => Server.Call("update");

    public static void WaitForAllLoads() => Server.Call("wait_for_all_loads");
