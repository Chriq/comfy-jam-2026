...
public class FmodEventEmitter3D
{
    ...
    public FmodEventEmitter3D() : this(NativeName)
    {
    }
    protected FmodEventEmitter3D(StringName @class) : this(ClassDB.Instantiate(@class))
    {
    }
    protected FmodEventEmitter3D(Variant variant) : this((Node3D)variant)
    {
    }
    protected FmodEventEmitter3D([NotNull] Node3D @object)
    {
        _object = @object;
    }

    public static implicit operator Node3D(FmodEventEmitter3D self) => self?._object;
    public static implicit operator Variant(FmodEventEmitter3D self) => self?._object;
    public static explicit operator FmodEventEmitter3D(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
    ...
    public class PropertyName : Node3D.PropertyName
    {
        ...
        public static readonly StringName AutoRelease = "auto_release";
        public static readonly StringName AllowFadeout = "allow_fadeout";
        public static readonly StringName PreloadEvent = "preload_event";
    ...
    public class MethodName : Node3D.MethodName
    {
        ...
        public static readonly StringName SetEventName = "set_event_name";
        public static readonly StringName GetEventName = "get_event_name";
        public static readonly StringName SetEventGuid = "set_event_guid";
        public static readonly StringName GetEventGuid = "get_event_guid";
        public static readonly StringName SetAttached = "set_attached";
        public static readonly StringName IsAttached = "is_attached";
        public static readonly StringName SetAutoplay = "set_autoplay";
        public static readonly StringName IsAutoplay = "is_autoplay";
        public static readonly StringName SetAutoRelease = "set_auto_release";
        public static readonly StringName IsAutoRelease = "is_auto_release";
        public static readonly StringName SetAllowFadeout = "set_allow_fadeout";
        public static readonly StringName IsAllowFadeout = "is_allow_fadeout";
        public static readonly StringName SetPreloadEvent = "set_preload_event";
        public static readonly StringName IsPreloadEvent = "is_preload_event";
        ...
        public static readonly StringName ToolRemoveAllParameters = "tool_remove_all_parameters";
    ...
    public class SignalName : Node3D.SignalName
    {
        ...
        public static readonly StringName Restarted = "restarted";
        public static readonly StringName Stopped = "stopped";
    }

    private static readonly StringName NativeName = "FmodEventEmitter3D";
    ...
    public int RotationEditMode
    {
        ...
        set => _object.RotationEditMode = (Node3D.RotationEditModeEnum)value;
    }

    public int RotationOrder
    {
        get => (int)_object.RotationOrder;
        set => _object.RotationOrder = (EulerOrder)value;
    }
