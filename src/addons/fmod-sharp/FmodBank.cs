...
public class FmodBank
{
	...
	public FmodBank() : this(NativeName)
	{
	}
	protected FmodBank(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodBank(Variant variant) : this((RefCounted) variant)
	{
	}
	protected FmodBank([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(FmodBank self) => self?._object;
	public static implicit operator Variant(FmodBank self) => self?._object;
	public static explicit operator FmodBank(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	{
		public static readonly StringName GetLoadingState = "get_loading_state";
		public static readonly StringName GetBusCount = "get_bus_count";
		public static readonly StringName GetEventDescriptionCount = "get_event_description_count";
		public static readonly StringName GetStringCount = "get_string_count";
		public static readonly StringName GetVcaCount = "get_VCA_count";
		public static readonly StringName GetDescriptionList = "get_description_list";
		public static readonly StringName GetBusList = "get_bus_list";
		public static readonly StringName GetVcaList = "get_vca_list";
		public static readonly StringName IsValid = "is_valid";
		public static readonly StringName GetGodotResPath = "get_godot_res_path";
	...
	private static readonly StringName NativeName = "FmodBank";

	#region Methods

	public int GetLoadingState()
	{
		return (int)_object.Call(MethodName.GetLoadingState);
	}

	public int GetBusCount()
	{
		return (int)_object.Call(MethodName.GetBusCount);
	}

	public int GetEventDescriptionCount()
	{
		return (int)_object.Call(MethodName.GetEventDescriptionCount);
	}

	public int GetStringCount()
	{
		return (int)_object.Call(MethodName.GetStringCount);
	}

	public int GetVcaCount()
	{
		return (int)_object.Call(MethodName.GetVcaCount);
	}

	public Godot.Collections.Array GetDescriptionList()
	{
		return (Godot.Collections.Array)_object.Call(MethodName.GetDescriptionList);
	}

	public Godot.Collections.Array GetBusList()
	{
		return (Godot.Collections.Array)_object.Call(MethodName.GetBusList);
	}

	public Godot.Collections.Array GetVcaList()
	{
		return (Godot.Collections.Array)_object.Call(MethodName.GetVcaList);
	}
	...
	{
		return (string)_object.Call(MethodName.GetGodotResPath);
	}
