...
public class FmodSound3DSettings
{
    // Engine object used for calling engine methods
    protected Resource _object;

    public FmodSound3DSettings() : this(NativeName)
    {
    }
    protected FmodSound3DSettings(StringName @class) : this(ClassDB.Instantiate(@class))
    {
    }
    protected FmodSound3DSettings(Variant variant) : this((Resource)variant)
    {
    }
    protected FmodSound3DSettings([NotNull] Resource @object)
    {
        _object = @object;
    }

    public static implicit operator Resource(FmodSound3DSettings self) => self?._object;
    public static implicit operator Variant(FmodSound3DSettings self) => self?._object;
    public static explicit operator FmodSound3DSettings(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

    public class PropertyName : Resource.PropertyName
    {
        public static readonly StringName DopplerScale = "doppler_scale";
        public static readonly StringName DistanceFactor = "distance_factor";
        public static readonly StringName RolloffScale = "rolloff_scale";
    }

    public class MethodName : Resource.MethodName
    {
        public static readonly StringName SetDopplerScale = "set_doppler_scale";
        public static readonly StringName GetDopplerScale = "get_doppler_scale";
        public static readonly StringName SetDistanceFactor = "set_distance_factor";
        public static readonly StringName GetDistanceFactor = "get_distance_factor";
        public static readonly StringName SetRolloffScale = "set_rolloff_scale";
        public static readonly StringName GetRolloffScale = "get_rolloff_scale";
    }
    ...
    private static readonly StringName NativeName = "FmodSound3DSettings";

    #region Properties

    public float DopplerScale
    {
        get => (float)_object.Get(PropertyName.DopplerScale);
        set => _object.Set(PropertyName.DopplerScale, value);
    }

    public float DistanceFactor
    {
        get => (float)_object.Get(PropertyName.DistanceFactor);
        set => _object.Set(PropertyName.DistanceFactor, value);
    }

    public float RolloffScale
    {
        get => (float)_object.Get(PropertyName.RolloffScale);
        set => _object.Set(PropertyName.RolloffScale, value);
    }
    ...
    public void SetDopplerScale(float @p_doppler_scale)
    {
        _object.Call(MethodName.SetDopplerScale, @p_doppler_scale);
    }

    public float GetDopplerScale()
    {
        return (float)_object.Call(MethodName.GetDopplerScale);
    }

    public void SetDistanceFactor(float @p_distance_factor)
    {
        _object.Call(MethodName.SetDistanceFactor, @p_distance_factor);
    }

    public float GetDistanceFactor()
    {
        return (float)_object.Call(MethodName.GetDistanceFactor);
    }

    public void SetRolloffScale(float @p_rolloff_scale)
    {
        _object.Call(MethodName.SetRolloffScale, @p_rolloff_scale);
    }

    public float GetRolloffScale()
    {
        return (float)_object.Call(MethodName.GetRolloffScale);
    }
