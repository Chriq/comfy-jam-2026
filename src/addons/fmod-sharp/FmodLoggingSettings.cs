...
public class FmodLoggingSettings
{
    // Engine object used for calling engine methods
    protected Resource _object;

    public FmodLoggingSettings() : this(NativeName)
    {
    }
    protected FmodLoggingSettings(StringName @class) : this(ClassDB.Instantiate(@class))
    {
    }
    protected FmodLoggingSettings(Variant variant) : this((Resource)variant)
    {
    }
    protected FmodLoggingSettings([NotNull] Resource @object)
    {
        _object = @object;
    }

    public static implicit operator Resource(FmodLoggingSettings self) => self?._object;
    public static implicit operator Variant(FmodLoggingSettings self) => self?._object;
    public static explicit operator FmodLoggingSettings(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

    public class PropertyName : Resource.PropertyName
    {
        public static readonly StringName DebugLevel = "debug_level";
        public static readonly StringName LogOutput = "log_output";
        public static readonly StringName LogFilePath = "log_file_path";
    }

    public class MethodName : Resource.MethodName
    {
        public static readonly StringName SetDebugLevel = "set_debug_level";
        public static readonly StringName GetDebugLevel = "get_debug_level";
        public static readonly StringName SetLogOutput = "set_log_output";
        public static readonly StringName GetLogOutput = "get_log_output";
        public static readonly StringName SetLogFilePath = "set_log_file_path";
        public static readonly StringName GetLogFilePath = "get_log_file_path";
    }
    ...
    private static readonly StringName NativeName = "FmodLoggingSettings";
    ...
    public enum FMOD_DEBUG_MODE : long
    {
        Tty = 0L,
        Callback = 2L,
        File = 1L,
    ...
    {
        get => (int)_object.Get(PropertyName.DebugLevel);
        set => _object.Set(PropertyName.DebugLevel, value);
    }

    public int LogOutput
    {
        get => (int)_object.Get(PropertyName.LogOutput);
        set => _object.Set(PropertyName.LogOutput, value);
    }

    public string LogFilePath
    {
        get => (string)_object.Get(PropertyName.LogFilePath);
        set => _object.Set(PropertyName.LogFilePath, value);
    }
    ...
    {
        _object.Call(MethodName.SetDebugLevel, @debug_level);
    }

    public int GetDebugLevel()
    {
        return (int)_object.Call(MethodName.GetDebugLevel);
    }

    public void SetLogOutput(int @log_output)
    {
        _object.Call(MethodName.SetLogOutput, @log_output);
    }

    public int GetLogOutput()
    {
        return (int)_object.Call(MethodName.GetLogOutput);
    }

    public void SetLogFilePath(string @log_file_path)
    {
        _object.Call(MethodName.SetLogFilePath, @log_file_path);
    }

    public string GetLogFilePath()
    {
        return (string)_object.Call(MethodName.GetLogFilePath);
    }
