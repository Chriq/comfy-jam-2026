...
public class FmodEditorPlugin
{
    // Engine object used for calling engine methods
    protected EditorPlugin _object;

    public FmodEditorPlugin() : this(NativeName)
    {
    }
    protected FmodEditorPlugin(StringName @class) : this(ClassDB.Instantiate(@class))
    {
    }
    protected FmodEditorPlugin(Variant variant) : this((EditorPlugin)variant)
    {
    }
    protected FmodEditorPlugin([NotNull] EditorPlugin @object)
    {
        _object = @object;
    }

    public static implicit operator EditorPlugin(FmodEditorPlugin self) => self?._object;
    public static implicit operator Variant(FmodEditorPlugin self) => self?._object;
    public static explicit operator FmodEditorPlugin(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
    ...
    private static readonly StringName NativeName = "FmodEditorPlugin";
