...
public class FmodVCA
{
	...
	public FmodVCA() : this(NativeName)
	{
	}
	protected FmodVCA(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodVCA(Variant variant) : this((RefCounted) variant)
	{
	}
	protected FmodVCA([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(FmodVCA self) => self?._object;
	public static implicit operator Variant(FmodVCA self) => self?._object;
	public static explicit operator FmodVCA(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "FmodVCA";
