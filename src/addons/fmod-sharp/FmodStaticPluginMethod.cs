...
public class FmodStaticPluginMethod
{
    // Engine object used for calling engine methods
    protected Resource _object;

    public FmodStaticPluginMethod() : this(NativeName)
    {
    }
    protected FmodStaticPluginMethod(StringName @class) : this(ClassDB.Instantiate(@class))
    {
    }
    protected FmodStaticPluginMethod(Variant variant) : this((Resource)variant)
    {
    }
    protected FmodStaticPluginMethod([NotNull] Resource @object)
    {
        _object = @object;
    }

    public static implicit operator Resource(FmodStaticPluginMethod self) => self?._object;
    public static implicit operator Variant(FmodStaticPluginMethod self) => self?._object;
    public static explicit operator FmodStaticPluginMethod(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

    public class PropertyName : Resource.PropertyName
    {
        public static readonly StringName Type = "type";
        public static readonly StringName MethodName = "method_name";
    }
    ...
    public class MethodName : Resource.MethodName
    {
        ...
        public static readonly StringName SetMethodName = "set_method_name";
        public static readonly StringName GetMethodName = "get_method_name";
    }
    ...
    private static readonly StringName NativeName = "FmodStaticPluginMethod";
    ...
    public int Type
    {
        get => (int)_object.Get(PropertyName.Type);
        set => _object.Set(PropertyName.Type, value);
    }

    // public string MethodName
    // {
    //     get => (string)_object.Get(PropertyName.MethodName);
    //     set => _object.Set(PropertyName.MethodName, value);
    // }
    ...
    public void SetType(FmodStaticPluginMethod.TypeEnum @p_type)
    {
        _object.Call(FmodStaticPluginMethod.MethodName.SetType, (int)@p_type);
    }

    public FmodStaticPluginMethod.TypeEnum GetType()
    {
        return (FmodStaticPluginMethod.TypeEnum)(int)_object.Call(MethodName.GetType);
    }

    public void SetMethodName(string @p_method_name)
    {
        _object.Call(MethodName.SetMethodName, @p_method_name);
    }

    public string GetMethodName()
    {
        return (string)_object.Call(MethodName.GetMethodName);
    }
